...
final Universe _univ = new Universe(Arrays.asList("node0", "quorum0", "value0", "__KOD_TRUE__", "__KOD_FALSE__"));
...
_b.boundExactly(this.sorts.get("__KOD_BOOL__"), _f.setOf("__KOD_TRUE__", "__KOD_FALSE__"));
