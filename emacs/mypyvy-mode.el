...
(defconst mypyvy-keyword-regex
  "\\<\\(modifies\\|sort\\|mutable\\|immutable\\|relation\\|constant\\|function\\|init\\|transition\\|definition\\|invariant\\|axiom\\|old\\|new\\|forall\\|exists\\|true\\|false\\|zerostate\\|onestate\\|twostate\\|theorem\\|assume\\|global\\|safety\\|self\\|derived\\|trace\\|assert\\|any\\|if\\|then\\|else\\|let\\|in\\|sat\\|unsat\\|distinct\\)\\>")
