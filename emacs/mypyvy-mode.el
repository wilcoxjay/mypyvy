...
(defconst mypyvy-keyword-regex
  "\\<\\(modifies\\|sort\\|mutable\\|immutable\\|relation\\|constant\\|function\\|init\\|transition\\|definition\\|invariant\\|axiom\\|old\\|new\\|forall\\|exists\\|true\\|false\\|zerostate\\|onestate\\|twostate\\|theorem\\|assume\\|automaton\\|global\\|safety\\|phase\\|self\\|derived\\|sketch\\|trace\\|assert\\|any\\|if\\|then\\|else\\|let\\|in\\|sat\\|unsat\\|distinct\\)\\>")
